...
void DPVisualizer::VizContourGraph(const CTNodeStack& contour_graph) 
{
    ...
    this->SetMarker(VizColor::EMERALD, "polygon_vertex",   0.5f, 0.5f,   contour_vertex_marker);    //ctnode
    ...
    this->SetMarker(VizColor::BLUE,    "vertex_angle",     0.15f, 0.75f, contour_surf_marker);      //surf_dir showing point
    this->SetMarker(VizColor::BLUE,    "angle_direct",     0.25f, 0.75f, contour_helper_marker);    //line ctnode and surf_dir showing point
...
void DPVisualizer::VizGraph(const NodePtrStack& graph) {
    ...
    this->SetMarker(VizColor::WHITE,   "global_vertex",     0.5f,  0.5f,  nav_node_marker);     //nav node in the graph
    ...
    this->SetMarker(VizColor::WHITE,   "global_vgraph",     0.1f,  0.2f,  edge_marker);         //nav_node_traj
